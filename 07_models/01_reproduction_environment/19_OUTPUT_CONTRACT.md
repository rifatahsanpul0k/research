...
For Colab execution, the same directory contract applies. Sync compact reproducibility artifacts and required small outputs back for local review. Keep large checkpoints, embeddings, temporary matrices and caches outside Git, with their storage location and checksums recorded when needed for reproduction.
