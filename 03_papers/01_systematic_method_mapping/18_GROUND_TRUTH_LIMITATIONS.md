...
Current annotations may be manual, hierarchical, incomplete, clustering-derived or assay-specific. ARI with an annotation is agreement with that reference, not absolute biological truth. Spots may contain mixtures, and stage labels do not establish lineage. Evaluation reports must preserve annotation provenance and uncertainty.
