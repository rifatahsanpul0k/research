...
Relation-specific W_r transforms preserve edge semantics; weights are not causal effects.
...
Relation-specific W_r transforms preserve edge semantics; weights are not causal effects. Latent dimensions and learned weights are not direct measurements.

## Evidence

Schlichtkrull et al. (2018). See `SOURCES.md`; no project dataset was fitted.
