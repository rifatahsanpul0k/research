...
Attention(Q_A,K_B,V_B) lets A query B computationally; it does not establish mechanistic influence.
...
Attention(Q_A,K_B,V_B) lets A query B computationally; it does not establish mechanistic influence. Latent dimensions and learned weights are not direct measurements.

## Evidence

Vaswani et al. (2017). See `SOURCES.md`; no project dataset was fitted.
