...
Encoder and domain discriminator trade task fit against domain confusion; failure to predict is not correctness.
...
Encoder and domain discriminator trade task fit against domain confusion; failure to predict is not correctness. Latent dimensions and learned weights are not direct measurements.

## Evidence

Ganin et al. (2016). See `SOURCES.md`; no project dataset was fitted.
