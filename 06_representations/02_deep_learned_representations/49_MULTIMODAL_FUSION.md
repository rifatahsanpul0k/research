...
Early, intermediate, late and expert fusion make different scale and missingness assumptions.
...
Early, intermediate, late and expert fusion make different scale and missingness assumptions. Latent dimensions and learned weights are not direct measurements.

## Evidence

Baltrušaitis et al. (2019). See `SOURCES.md`; no project dataset was fitted.
