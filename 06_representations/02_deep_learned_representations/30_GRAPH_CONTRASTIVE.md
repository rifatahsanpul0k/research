...
Declared graph views and positive pairs maximize agreement; augmentations may remove tissue biology.
...
Declared graph views and positive pairs maximize agreement; augmentations may remove tissue biology. Latent dimensions and learned weights are not direct measurements.

## Evidence

You et al. (2020). See `SOURCES.md`; no project dataset was fitted.
