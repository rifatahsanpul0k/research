...
Typed nodes/relations use type-specific transformations; edge types require provenance.
...
Typed nodes/relations use type-specific transformations; edge types require provenance. Latent dimensions and learned weights are not direct measurements.
