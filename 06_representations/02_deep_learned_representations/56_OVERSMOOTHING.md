...
Deep propagation can make connected node states equal and erase boundaries; distinct from oversquashing.
...
Deep propagation can make connected node states equal and erase boundaries; distinct from oversquashing. Latent dimensions and learned weights are not direct measurements.

## Evidence

Oono & Suzuki (2020). See `SOURCES.md`; no project dataset was fitted.
