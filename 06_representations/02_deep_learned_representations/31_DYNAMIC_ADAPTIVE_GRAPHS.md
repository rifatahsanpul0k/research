# Dynamic adaptive graphs

Phase 2C · method study · studied_not_fitted · not_reproduced.

## Definition and mechanism

A=f_theta(X) couples topology and representation; learned edges are hypotheses.
...
A=f_theta(X) couples topology and representation; learned edges are hypotheses. Latent dimensions and learned weights are not direct measurements.

## Evidence

adaptive graph learning literature. See `SOURCES.md`; no project dataset was fitted.
