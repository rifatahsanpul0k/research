...
z_1=...=z_n is degenerate; variance and rank diagnostics are required.
...
z_1=. Latent dimensions and learned weights are not direct measurements.

## Evidence

Grill et al. (2020); Chen & He (2021). See `SOURCES.md`; no project dataset was fitted.
