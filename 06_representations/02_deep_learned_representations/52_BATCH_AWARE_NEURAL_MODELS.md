# Batch-aware neural models

Phase 2C · method study · studied_not_fitted · not_reproduced.

## Definition and mechanism

Batch covariates, conditional decoders and adversarial objectives target technical variation but can remove confounded biology.
...
Batch covariates, conditional decoders and adversarial objectives target technical variation but can remove confounded biology. Latent dimensions and learned weights are not direct measurements.

## Evidence

Lopez et al. (2018); Korsunsky et al. (2019). See `SOURCES.md`; no project dataset was fitted.
