...
Attribution, saliency, decoder weights and attention answer different questions; post-hoc importance is not causality.
...
Attribution, saliency, decoder weights and attention answer different questions; post-hoc importance is not causality. Latent dimensions and learned weights are not direct measurements.

## Evidence

Rudin (2019); Jain & Wallace (2019). See `SOURCES.md`; no project dataset was fitted.
