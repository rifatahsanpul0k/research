...
RNA feature/spatial graph intersection creates shared-edge scaffold, then GCN and hierarchical fusion.
...
RNA feature/spatial graph intersection creates shared-edge scaffold, then GCN and hierarchical fusion. Latent dimensions and learned weights are not direct measurements.

## Evidence

ARISE primary record (2026), qualified. See `SOURCES.md`; no project dataset was fitted.
