...
Independent/weakly supervised factors are not automatically pathways or cell states.
...
Independent/weakly supervised factors are not automatically pathways or cell states. Latent dimensions and learned weights are not direct measurements.

## Evidence

Locatello et al. (2019). See `SOURCES.md`; no project dataset was fitted.
