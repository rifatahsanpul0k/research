...
G=(V,E) with node features X; message passing aggregates neighbors. Embeddings depend on adjacency and features.
...
G=(V,E) with node features X; message passing aggregates neighbors. Latent dimensions and learned weights are not direct measurements.

## Evidence

Kipf & Welling (2017); Hamilton et al. (2017). See `SOURCES.md`; no project dataset was fitted.
