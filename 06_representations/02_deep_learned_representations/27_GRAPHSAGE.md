...
Sampled aggregators support inductive node embeddings when feature schema and neighbors are available.
...
Sampled aggregators support inductive node embeddings when feature schema and neighbors are available. Latent dimensions and learned weights are not direct measurements.

## Evidence

Hamilton et al. (2017). See `SOURCES.md`; no project dataset was fitted.
