...
Metric, k/radius, coordinates, features and weights alter A and every GNN embedding.
...
Metric, k/radius, coordinates, features and weights alter A and every GNN embedding. Latent dimensions and learned weights are not direct measurements.
