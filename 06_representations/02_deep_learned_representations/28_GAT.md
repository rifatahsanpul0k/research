...
alpha_ij=softmax(e_ij) weights masked neighbors; attention is not biological importance or causality.
...
alpha_ij=softmax(e_ij) weights masked neighbors; attention is not biological importance or causality. Latent dimensions and learned weights are not direct measurements.

## Evidence

Veličković et al. (2018). See `SOURCES.md`; no project dataset was fitted.
