...
Incidence H supports node-group-node aggregation; hyperedges need documented membership.
...
Incidence H supports node-group-node aggregation; hyperedges need documented membership. Latent dimensions and learned weights are not direct measurements.

## Evidence

Feng et al. (2019). See `SOURCES.md`; no project dataset was fitted.
