# Missing modality models

Phase 2C · method study · studied_not_fitted · not_reproduced.

## Definition and mechanism

Masks, dropout, shared latent, conditional generation and experts differ in whether absent views are predicted or marginalized.
...
Masks, dropout, shared latent, conditional generation and experts differ in whether absent views are predicted or marginalized. Latent dimensions and learned weights are not direct measurements.

## Evidence

MultiVI and MIDAS records. See `SOURCES.md`; no project dataset was fitted.
