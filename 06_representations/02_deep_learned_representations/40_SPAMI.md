...
Spatial graph, view-specific GNNs, DGI-like contrast, cosine regularization, attention fusion and reconstruction.
...
Spatial graph, view-specific GNNs, DGI-like contrast, cosine regularization, attention fusion and reconstruction. Latent dimensions and learned weights are not direct measurements.

## Evidence

Gao et al. (2025). See `SOURCES.md`; no project dataset was fitted.
