...
Many distant messages pass through narrow bottlenecks; depth alone does not restore information.
...
Many distant messages pass through narrow bottlenecks; depth alone does not restore information. Latent dimensions and learned weights are not direct measurements.

## Evidence

Alon & Yahav (2021). See `SOURCES.md`; no project dataset was fitted.
