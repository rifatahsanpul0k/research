...
VGAE plus graph contrastive/alignment components for single-cell and spatial atlas embeddings; exact provenance qualified.
...
VGAE plus graph contrastive/alignment components for single-cell and spatial atlas embeddings; exact provenance qualified. Latent dimensions and learned weights are not direct measurements.

## Evidence

Garfield primary record (2026), qualified. See `SOURCES.md`; no project dataset was fitted.
