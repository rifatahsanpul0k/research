...
Modality encoders plus guidance graph and alignment objectives; guidance is a prior, not ground truth.
...
Modality encoders plus guidance graph and alignment objectives; guidance is a prior, not ground truth. Latent dimensions and learned weights are not direct measurements.

## Evidence

Cao & Gao (2022). See `SOURCES.md`; no project dataset was fitted.
