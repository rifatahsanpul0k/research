# Generative versus contrastive

Phase 2C · method study · studied_not_fitted · not_reproduced.

## Definition and mechanism

Likelihood/reconstruction or ELBO differs from relative agreement of declared views and negatives.
...
Likelihood/reconstruction or ELBO differs from relative agreement of declared views and negatives. Latent dimensions and learned weights are not direct measurements.

## Evidence

Kingma & Welling (2014); van den Oord et al. (2018). See `SOURCES.md`; no project dataset was fitted.
