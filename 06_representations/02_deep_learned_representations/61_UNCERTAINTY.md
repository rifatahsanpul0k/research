...
Aleatoric and epistemic uncertainty use likelihoods, posteriors or ensembles; calibration differs from confidence.
...
Aleatoric and epistemic uncertainty use likelihoods, posteriors or ensembles; calibration differs from confidence. Latent dimensions and learned weights are not direct measurements.

## Evidence

Kendall & Gal (2017). See `SOURCES.md`; no project dataset was fitted.
