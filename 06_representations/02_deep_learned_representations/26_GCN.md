...
H_next=sigma(D^-1/2 A H W); self-loops and degree normalization control smoothing; shapes are n×d.
...
H_next=sigma(D^-1/2 A H W); self-loops and degree normalization control smoothing; shapes are n×d. Latent dimensions and learned weights are not direct measurements.

## Evidence

Kipf & Welling (2017). See `SOURCES.md`; no project dataset was fitted.
