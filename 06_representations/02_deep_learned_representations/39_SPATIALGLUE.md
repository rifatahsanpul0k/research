...
Spatial multi-omics GNN/fusion produces spot embeddings conditional on graph and preprocessing.
...
Spatial multi-omics GNN/fusion produces spot embeddings conditional on graph and preprocessing. Latent dimensions and learned weights are not direct measurements.

## Evidence

Long et al. (2024). See `SOURCES.md`; no project dataset was fitted.
