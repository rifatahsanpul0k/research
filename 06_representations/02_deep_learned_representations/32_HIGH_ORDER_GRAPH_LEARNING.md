# High-order graph learning

Phase 2C · method study · studied_not_fitted · not_reproduced.

## Definition and mechanism

A^2, diffusion, walks and motifs encode multi-hop context; this is not a hypergraph.
...
A^2, diffusion, walks and motifs encode multi-hop context; this is not a hypergraph. Latent dimensions and learned weights are not direct measurements.

## Evidence

Klicpera et al. (2019). See `SOURCES.md`; no project dataset was fitted.
