...
z_shared and z_modality-specific factorization is a model convention with identifiability limits.
...
z_shared and z_modality-specific factorization is a model convention with identifiability limits. Latent dimensions and learned weights are not direct measurements.

## Evidence

Cobolt and MIDAS records. See `SOURCES.md`; no project dataset was fitted.
