# Biological-prior neural models

Phase 2C · method study · studied_not_fitted · not_reproduced.

## Definition and mechanism

Pathways, regulatory, PPI, ontology and spatial relations constrain networks; priors are not ground truth.
...
Pathways, regulatory, PPI, ontology and spatial relations constrain networks; priors are not ground truth. Latent dimensions and learned weights are not direct measurements.

## Evidence

scGLUE record. See `SOURCES.md`; no project dataset was fitted.
